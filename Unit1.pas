...
begin
 ...
 begin
    ShowMessage('Correct');
    h.Strings[i]:= IntToStr(StrToInt(h.Strings[i]) + 1);//увеличиваем счётчик регистраций
    ...
    if FormReg.Edit1.Text='admin'
      then FormAdmin.ShowModal   //открываем админа
      else FormUser.ShowModal;   // открываем форму юзера
      break;
 end
 else
  begin
